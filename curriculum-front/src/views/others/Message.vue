                        ...
                        <div class="card"> 
                          ...
                          >
                            <form>
                              ...
                              >
                                <textarea :error-messages="errors" class="comment message-content" name="comment" placeholder="Send message lovely" aria-required="true" v-model="comment"></textarea>
                              </validation-provider>
    ...
    methods: {
      ...mapActions(['postMailBox']),
        ...
        async sendMessage() {
          ...
          await this.postMailBox(dataSend);
          this.isActive = false;
        }
    }
}
