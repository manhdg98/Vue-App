            ...
            <v-row>
                <v-col xs="2" md="3" class="mt-10">
                    ...
                    <div class="envelope" :class="{active: isActive}">
                        ...
                        <div class="card"> 
                        <form>
                            <textarea class="comment message-content" name="comment" placeholder="Send message lovely" aria-required="true"></textarea>
                            <v-select
                ...
                <v-col xs="10" md="9" class="mailbox d-flex flex-wrap justify-center">
                    <mailBox nameMailBox="ManhNT"/>
                    <mailBox nameMailBox="ManhTT"/>
                    <mailBox nameMailBox="ThuanNK"/>
                    <mailBox nameMailBox="UyenVT"/>
                    <mailBox nameMailBox="ThinhAV"/>
                    <mailBox nameMailBox="TrangPTH"/>
                </v-col>
            </v-row>
        </v-container>
    </div>
...
body {text-align:center; height: 100%; width: 100%; overflow:hidden;}
